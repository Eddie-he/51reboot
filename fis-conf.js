    ...
    postprocessor:[function(content,file,settings){
    	...
    	return nunjucks.renderString(content,{
            ...
            teachers:{
                ...
                '萝卜':'曾在百度工作，多年cpp和go语言开发经验,从事自动化运维和基础架构相关工作。对分布式系统和高并发有着丰富的经验。主导过多个大型go语言项目，如部署系统、发布系统、会员账号体系等。亲眼见证了团队go语言的发展壮大。曾在百度工作，多年cpp和go语言开发经验,从事自动化运维和基础架构相关工作。对分布式系统和高并发有着丰富的经验。主导过多个大型go语言项目，如部署系统、发布系统、会员账号体系等。亲眼见证了团队go语言的发展壮大。',
            },
            share_list:[
            {
                // hide:true,
