...
// var color = d3.interpolate(a,b);//颜色插值函数
        ...
        var myChart = echarts.init(document.getElementById('pie2_2'));
...
//16 Elbow Touch PTS 0.7
            ...
            data:[
                {value:4.2, name:'Drive PTS'},
                {value:9.1, name:'Catch Shoot PTS'},
                {value:7.6, name:'Pull Up PTS'},
                {value:2.3, name:'Paint Touch PTS'},
